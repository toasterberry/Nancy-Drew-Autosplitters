...
state("Shadow")
{
	string5 scene : "Ndui.dll", 0x8E75C, 0x20, 0x4C, 0x8, 0x10, 0x18, 0x0; //Special edition
	//string5 scene : "Ndui.dll", 0x8B45C, 0x20, 0x64, 0x8, 0xC, 0x0;  //Remove the 2 slashes in front of "string5" if you have the normal edition, and add 2 slashes to the one above.
	/* Backups
	string5 scene : "Ndui.dll", 0x8B45C, 0x20, 0x0, 0x10, 0x4C, 0x8, 0xC, 0x0;
	string5 scene : 0x18A7A8, 0x2C, 0x24, 0x8, 0x8, 0x8, 0xC, 0x0; 
	string5 scene : "Ndui.dll", 0x8E75C, 0x10, 0x64, 0x8, 0x10, 0x18, 0x0; //Special Edition Backup
	*/
}
